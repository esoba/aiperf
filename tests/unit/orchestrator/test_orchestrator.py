...
class TestMultiRunOrchestrator:
    ...
    def mock_user_config(self):
        """Create an AIPerfConfig for use as the user config in execute calls."""
        config = _make_config(
            load={
                "warmup": {
                    "type": "concurrency",
    ...
    def test_execute_with_fixed_trials_strategy(
        self, mock_aiperf_config, mock_user_config, tmp_path
    ):
        """Test execute with FixedTrialsStrategy."""
        orchestrator = MultiRunOrchestrator(tmp_path, mock_aiperf_config)
    ...
    def test_extract_summary_metrics(self, mock_aiperf_config, tmp_path):
    ...
    def test_extract_summary_metrics_missing_file(self, mock_aiperf_config, tmp_path):
    ...
    def test_extract_summary_metrics_invalid_json(self, mock_aiperf_config, tmp_path):
    ...
    def test_extract_summary_metrics_preserves_structure(
        self, mock_aiperf_config, tmp_path
    ):
