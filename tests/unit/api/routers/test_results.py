...
@pytest.fixture
def results_router(mock_zmq, router_aiperf_config) -> ResultsRouter:
    return ResultsRouter(
        config=router_aiperf_config,
        service_config=router_aiperf_config,
    )
...
class TestResultsListEndpoint:
    ...
    def test_list_results_empty_directory(
        ...
        results_router.user_config.artifacts.dir = tmp_path / "nonexistent"
    ...
    def test_list_results_with_files(
        ...
        results_router.user_config.artifacts.dir = tmp_path
