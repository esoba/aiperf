...
from .conftest import make_info_labels, make_latency_metric, make_metric_result
...
class TestFormatAsPrometheus:
    ...
    def test_metric_labels_applied_to_all_value_lines(self) -> None:
        """Test that only model label is applied to measurement metrics."""
        ...
        for line in value_lines:
            ...
            # endpoint_type is excluded from measurement metrics (info-only)
            assert 'endpoint_type="chat"' not in line
...
class TestReplaceMap:
    ...
    def test_slash_replaced_with_per(self) -> None:
        ...
        from aiperf.api.prometheus_formatter import _UNIT_REPLACE_MAP
