...
class TestLoadConfig:
    ...
    def test_load_from_file_path(self, tmp_path: Path) -> None:
        data = {
            ...
            "initial_context": {"mean": 10000, "median": 8000},
        ...
        assert config.initial_context.mean == 10000
        assert config.initial_context.mu is not None
        assert config.initial_context.sigma is not None
    ...
    def test_load_manifest_as_config(self, tmp_path: Path) -> None:
        ...
        inner = {
            ...
            "initial_context": {"mean": 67000, "median": 54000},
