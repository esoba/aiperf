...
async def logs(
    ...
    *,
    ...
    follow: Annotated[bool, Parameter(name=["-f", "--follow"])] = False,
    tail: int | None = None,
    ...
    Args:
        job_id: The AIPerf job ID to get logs from (default: last deployed job).
        ...
        output: Directory to save log files (one per pod). Prints to stdout if not set.
    """
