...
class ArtifactsConfig(BaseModel):
    ...
    console: Annotated[
        ConsoleFormat,
        Field(
            default=ConsoleFormat.TABLE,
            description="Console output format for results display. "
            "table: rich formatted tables, json: machine-readable, minimal: progress only.",
        ),
    ]
