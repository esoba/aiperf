...
class BaseDatasetLoader(AIPerfLoggerMixin, ABC):
    ...
    def load(self) -> list[Conversation]:
        """Load and return conversations ready for the dataset manager.
    ...
    # ---- Conversation finalization (from BaseDatasetComposer) ----

    def _finalize_conversations(self, conversations: list[Conversation]) -> None:
        """Finalize conversations by injecting context prompts.

        Args:
            conversations: Conversations to finalize.
        """
    ...
    def _inject_context_prompts(self, conversations: list[Conversation]) -> None:
        ...
        Args:
            conversations: Conversations to inject prompts into.
        """
