...
class PromptConfig(BaseConfig):
    ...
    pre_generate_responses: Annotated[
        bool,
        Field(
            description="Include assistant text responses in coding tool-use history. "
            "When --prompt-corpus coding is used with multi-turn traces, tool-use "
            "conversation history is always injected into the ISL. This flag controls "
            "whether assistant summary/preamble text is also included between tool "
            "rounds, increasing the realism of the conversation history.",
        ),
        CLIParameter(
