...
from . import riva_nlp_pb2 as riva_dot_riva__nlp__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in riva/riva_nlp_pb2_grpc.py depends on'
...
class RivaLanguageUnderstandingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ClassifyText = channel.unary_unary(
                ...
                request_serializer=riva_dot_riva__nlp__pb2.TextClassRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.TextClassResponse.FromString,
                _registered_method=True)
        self.ClassifyTokens = channel.unary_unary(
                '/nvidia.riva.nlp.RivaLanguageUnderstanding/ClassifyTokens',
                request_serializer=riva_dot_riva__nlp__pb2.TokenClassRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.TokenClassResponse.FromString,
                _registered_method=True)
        self.TransformText = channel.unary_unary(
                '/nvidia.riva.nlp.RivaLanguageUnderstanding/TransformText',
                request_serializer=riva_dot_riva__nlp__pb2.TextTransformRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.TextTransformResponse.FromString,
                _registered_method=True)
        self.AnalyzeEntities = channel.unary_unary(
                '/nvidia.riva.nlp.RivaLanguageUnderstanding/AnalyzeEntities',
                request_serializer=riva_dot_riva__nlp__pb2.AnalyzeEntitiesRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.TokenClassResponse.FromString,
                _registered_method=True)
        self.AnalyzeIntent = channel.unary_unary(
                '/nvidia.riva.nlp.RivaLanguageUnderstanding/AnalyzeIntent',
                request_serializer=riva_dot_riva__nlp__pb2.AnalyzeIntentRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.AnalyzeIntentResponse.FromString,
                _registered_method=True)
        ...
        self.NaturalQuery = channel.unary_unary(
                ...
                request_serializer=riva_dot_riva__nlp__pb2.NaturalQueryRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.NaturalQueryResponse.FromString,
                _registered_method=True)
        self.GetRivaNLPConfig = channel.unary_unary(
                '/nvidia.riva.nlp.RivaLanguageUnderstanding/GetRivaNLPConfig',
                request_serializer=riva_dot_riva__nlp__pb2.RivaNLPConfigRequest.SerializeToString,
                response_deserializer=riva_dot_riva__nlp__pb2.RivaNLPConfigResponse.FromString,
                _registered_method=True)
...
def add_RivaLanguageUnderstandingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ClassifyText': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=riva_dot_riva__nlp__pb2.TextClassRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.TextClassResponse.SerializeToString,
            ),
            'ClassifyTokens': grpc.unary_unary_rpc_method_handler(
                    servicer.ClassifyTokens,
                    request_deserializer=riva_dot_riva__nlp__pb2.TokenClassRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.TokenClassResponse.SerializeToString,
            ),
            'TransformText': grpc.unary_unary_rpc_method_handler(
                    servicer.TransformText,
                    request_deserializer=riva_dot_riva__nlp__pb2.TextTransformRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.TextTransformResponse.SerializeToString,
            ),
            'AnalyzeEntities': grpc.unary_unary_rpc_method_handler(
                    servicer.AnalyzeEntities,
                    request_deserializer=riva_dot_riva__nlp__pb2.AnalyzeEntitiesRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.TokenClassResponse.SerializeToString,
            ),
            'AnalyzeIntent': grpc.unary_unary_rpc_method_handler(
                    servicer.AnalyzeIntent,
                    request_deserializer=riva_dot_riva__nlp__pb2.AnalyzeIntentRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.AnalyzeIntentResponse.SerializeToString,
            ),
            ...
            'NaturalQuery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=riva_dot_riva__nlp__pb2.NaturalQueryRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.NaturalQueryResponse.SerializeToString,
            ),
            'GetRivaNLPConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.GetRivaNLPConfig,
                    request_deserializer=riva_dot_riva__nlp__pb2.RivaNLPConfigRequest.FromString,
                    response_serializer=riva_dot_riva__nlp__pb2.RivaNLPConfigResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'nvidia.riva.nlp.RivaLanguageUnderstanding', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('nvidia.riva.nlp.RivaLanguageUnderstanding', rpc_method_handlers)
...
class RivaLanguageUnderstanding(object):
    ...
    def ClassifyText(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/ClassifyText',
            riva_dot_riva__nlp__pb2.TextClassRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.TextClassResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ClassifyTokens(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/ClassifyTokens',
            riva_dot_riva__nlp__pb2.TokenClassRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.TokenClassResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def TransformText(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/TransformText',
            riva_dot_riva__nlp__pb2.TextTransformRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.TextTransformResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def AnalyzeEntities(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/AnalyzeEntities',
            riva_dot_riva__nlp__pb2.AnalyzeEntitiesRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.TokenClassResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def AnalyzeIntent(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/AnalyzeIntent',
            riva_dot_riva__nlp__pb2.AnalyzeIntentRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.AnalyzeIntentResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def NaturalQuery(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/NaturalQuery',
            riva_dot_riva__nlp__pb2.NaturalQueryRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.NaturalQueryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetRivaNLPConfig(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/nvidia.riva.nlp.RivaLanguageUnderstanding/GetRivaNLPConfig',
            riva_dot_riva__nlp__pb2.RivaNLPConfigRequest.SerializeToString,
            riva_dot_riva__nlp__pb2.RivaNLPConfigResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
