...
if TYPE_CHECKING:
    ...
    from aiperf.plugin.enums import ArrivalPattern, CommClientType, CommunicationBackend, ComposerType, ConsoleExporterType, CustomDatasetType, DataExporterType, DatasetBackingStoreType, DatasetClientStoreType, DatasetSamplingStrategy, EndpointType, GPUTelemetryCollectorType, PlotType, PluginType, PluginTypeStr, RampType, RecordProcessorType, ResultsProcessorType, ServerMetricsCollectorType, ServiceRunType, ServiceType, TimingMode, TransportType, UIType, URLSelectionStrategy, ZMQProxyType
    ...
    @overload
    def get_class(category: Literal[PluginType.SERVER_METRICS_COLLECTOR, "server_metrics_collector"], name_or_class_path: ServerMetricsCollectorType | str) -> type[ServerMetricsCollectorProtocol]: ...
    @overload
    def iter_all(category: Literal[PluginType.SERVER_METRICS_COLLECTOR, "server_metrics_collector"]) -> Iterator[tuple[PluginEntry, type[ServerMetricsCollectorProtocol]]]: ...
    @overload
